...
@MainActor class LocationsHandler: ObservableObject {
    let logger = Logger(subsystem: "tokyo.dev.liveUpdates", category: "LocationsHandler")
...
//        center: CLLocationCoordinate2D(latitude: 31.23645, longitude: 121.52223),
